...
class CatalogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create catalog" do
    assert_difference("Catalog.count") do
      post catalogs_url, params: { catalog: { created_by: @catalog.created_by, description: @catalog.description, modified_by: @catalog.modified_by, name: @catalog.name } }
    end
  ...
  test "should update catalog" do
    patch catalog_url(@catalog), params: { catalog: { created_by: @catalog.created_by, description: @catalog.description, modified_by: @catalog.modified_by, name: @catalog.name } }
